/**
 * Maakt SubscriptionInvoice-tabel aan indien ontbrekend.
 */
...
async function main() {
  console.log("🔍 Controleren SubscriptionInvoice-tabel...");
  const prisma = new PrismaClient();
  try {
    for (const sql of STATEMENTS) {
      await prisma.$executeRawUnsafe(sql);
    }
    console.log("✅ SubscriptionInvoice-tabel is aanwezig");
  } finally {
